...
void deconvolution(){
  ...
  string fnms[nProcDef]={
		      ...
		      // "../epInelastic_SegmentedV1_shldAnaV7.root",
		      // "../epInelastic_SegmentedV1_shldAnaV7.root",
		      "histos/ee_Hybrid_shldAnaV7.root",
		      "histos/epElastic_Hybrid_shldAnaV7.root",
		      "histos/epInelastic_Hybrid_shldAnaV7.root",
		      "histos/epInelastic_Hybrid_shldAnaV7.root",
		      "histos/epInelastic_Hybrid_shldAnaV7.root",
		      "histos/eAlElastic_bkgAnaV4.root",
		      "histos/eAlQuasielastic_bkgAnaV4.root",
		      "histos/eAlInelastic_bkgAnaV4.root",
...
void analyzeOne(int ring, int sect){
  ...
  for(int i=0;i<nMatrix;i++){
    ...
    cout<<procNm[i]<<"\t"<<A[i][ring][sect]<<"\t"<<sigma[i]<<"\t"<<sigma[i]/fabs(A[i][ring][sect])*100.<<endl;
  }
